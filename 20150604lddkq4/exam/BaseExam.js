...
var BaseExam = (function (_super) {
    ...
    function BaseExam() {
        ...
        //返回主页
        var tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 0, 71, 69, 0, 0, 0], [0, 0, 71, 69, 0, 0, 0], [71, 0, 71, 69, 0, 0, 0]] }));
        tmp_mc.x = 7;
        tmp_mc.y = 4;
        ...
        //菜单
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[141, 69, 71, 68, 0, 0, 0], [141, 69, 71, 68, 0, 0, 0], [0, 206, 71, 68, 0, 0, 0]] }));
        tmp_mc.x = 163;
        tmp_mc.y = 4;
        new createjs.ButtonHelper(tmp_mc, 0, 1, 2, false);
