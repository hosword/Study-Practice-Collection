...
var LookExam0 = (function (_super) {
    ...
    function LookExam0() {
        ...
        img = lib.getResult("XZT");
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: 
        	[[0,0,127,380,0,-245.35,368.45],[0,0,127,380,0,-245.35,368.45],[127,0,123,376,0,-253.35,368.45],[127,0,123,376,0,-253.35,368.45],[250,0,122,369,0,-256.35,368.45],[250,0,122,369,0,-256.35,368.45],[372,0,126,370,0,-238.35,368.45],[372,0,126,370,0,-238.35,368.45]]}));
        tmp_mc.x = 100;
        tmp_mc.y = 100;
        tmp_mc.mouseEnabled = false;
        this.xzt_mc = tmp_mc;
        
         img = lib.getResult("LZ");
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: 
        	[[0,0,22,128,0,-195.2,121.6]]}));
        tmp_mc.x = 100;
        tmp_mc.y = 100;
        tmp_mc.mouseEnabled = false;
        this.lz_mc = tmp_mc;
