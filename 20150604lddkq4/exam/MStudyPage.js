...
var MStudyPage = (function (_super) {
    ...
    MStudyPage.prototype.configUI = function () {
        ...
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 277, 158, 53, 0, -4, -2], [0, 115, 165, 56, 0, 0, 0], [0, 330, 158, 53, 0, -4, -2]] }));
        tmp_mc.x = 357;
        tmp_mc.y = 8;
        this.XXA0 = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 171, 158, 53, 0, -4, -2], [0, 59, 165, 56, 0, 0, 0], [0, 224, 158, 53, 0, -4, -2]] }));
        tmp_mc.x = 565;
        tmp_mc.y = 8;
        this.XXA1 = tmp_mc;

        tmp_mc = this.XXA0;
        tmp2_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 0, 169, 59, 0, 0, 0]] }));
    ...
    MStudyPage.prototype.show = function () {
        ...
        this.btnClickHandler({ target: this.XXA0 });
    };
