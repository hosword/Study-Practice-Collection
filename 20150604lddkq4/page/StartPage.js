...
var StartPage = (function (_super) {
    ...
    StartPage.prototype.configUI = function () {
        ...
        //tv框
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 206, 827, 614, 0, 12.75, 15.15]] }));
        tmp_mc.x = 17;
        tmp_mc.y = 3;
        ...
        //蘑菇
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 0, 979, 206, 0, 0, 12]] }));
        tmp_mc.x = -45;
        tmp_mc.y = 500;
        tmp_mc.mouseEnabled = false;
        this.mg_mc = tmp_mc;
        ...
        //博士
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 0, 182, 229, 0, -8.55, 1]] }));
        tmp_mc.x = 0;
        tmp_mc.y = 396;
        tmp_mc.mouseEnabled = false;
        this.bs_mc = tmp_mc;
        ...
        //小男孩身体
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[182, 0, 125, 122, 0, -8.75, -8.8]] }));
        tmp_mc.x = 593;
        tmp_mc.y = 58;
        tmp_mc.mouseEnabled = false;
        this.bb_mc = tmp_mc;
        ...
        //小男孩脸
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[307, 0, 139, 158, 0, -3.55, -7.8]] }));
        tmp_mc.x = 588;
        tmp_mc.y = -7;
        tmp_mc.mouseEnabled = false;
        this.bf_mc = tmp_mc;
        ...
        //看一看
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[258, 340, 223, 111, 0, -8.7, -71.15], [258, 340, 223, 111, 0, -8.7, -71.15], [0, 340, 258, 128, 0, 8.3, -62.15], [258, 340, 223, 111, 0, -8.7, -71.15]] }));
        tmp_mc.x = 785;
        tmp_mc.y = 141;
        this.do_mc = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[268, 151, 224, 133, 0, -5.65, -57.4], [268, 151, 224, 133, 0, -5.65, -57.4], [0, 181, 268, 159, 0, 14.35, -44.4], [268, 151, 224, 133, 0, -5.65, -57.4]] }));
        tmp_mc.x = 773;
        tmp_mc.y = 44;
        this.look_mc = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[261, 451, 225, 93, 0, 19.9, -106.1], [261, 451, 225, 93, 0, 19.9, -106.1], [0, 468, 261, 108, 0, 36.9, -99.1], [261, 451, 225, 93, 0, 19.9, -106.1]] }));
        tmp_mc.x = 844;
        tmp_mc.y = 358;
        this.show_mc = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[268, 0, 223, 151, 0, -2.9499999999999993, -44.95], [268, 0, 223, 151, 0, -2.9499999999999993, -44.95], [0, 0, 268, 181, 0, 18.05, -28.95], [268, 0, 223, 151, 0, -2.9499999999999993, -44.95]] }));
        tmp_mc.x = 822;
        tmp_mc.y = 266;
        ...
        //帮助
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[71, 137, 70, 68, 0, 0, 0], [71, 137, 70, 68, 0, 0, 0], [141, 137, 70, 68, 0, 0, 0]] }));
        tmp_mc.x = 971;
        tmp_mc.y = 4;
        new createjs.ButtonHelper(tmp_mc, 0, 1, 2, false);
        ...
        //退出
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[142, 0, 70, 69, 0, 0, 0], [142, 0, 70, 69, 0, 0, 0], [0, 69, 70, 69, 0, 0, 0]] }));
        tmp_mc.x = 1052;
        tmp_mc.y = 3;
        new createjs.ButtonHelper(tmp_mc, 0, 1, 2, false);
    ...
    StartPage.prototype.changeContentAt = function (ix) {
        if (this.visible) {
            ...
            createjs.Tween.get(this.pic_mc.scrollRect, { override: true }).to({ x: ix * this.pic_mc.scrollRect.width }, 300, createjs.Ease.circOut).wait(3000).call(this.next, [], this);
        }
    };
