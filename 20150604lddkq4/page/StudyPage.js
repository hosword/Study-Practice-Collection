...
var StudyPage = (function (_super) {
    ...
    StudyPage.prototype.configUI = function () {
        ...
        var sst = new createjs.SpriteSheet({
            ...
            frames: [[31, 0, 28, 50, 0, 0.5, 6], [170, 0, 21, 50, 0, 0.5, 6], [31, 50, 28, 50, 0, 0.5, 6], [59, 0, 28, 50, 0, 0.5, 6], [59, 50, 28, 50, 0, 0.5, 6], [87, 0, 28, 50, 0, 0.5, 6], [87, 50, 28, 50, 0, 0.5, 6], [143, 0, 27, 50, 0, 0.5, 6], [115, 0, 28, 50, 0, 0.5, 6], [115, 50, 28, 50, 0, 0.5, 6], [0, 0, 31, 50, 0, 2.5, 10], [0, 50, 31, 50, 0, 2.5, 10], [166, 50, 22, 50, 0, -2.5, -1], [143, 50, 23, 50, 0, -1.5, 6]]
        });
        ...
        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 264, 938, 94, 0, 509.65, 57.2]] }));
        tmp_mc.x = 595;
        tmp_mc.y = 603;
        this.page_mc = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 163, 926, 101, 0, 0, 10.55]] }));
        tmp_mc.x = 106;
        tmp_mc.y = 2;
        this.title_mc = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[128, 358, 53, 79, 0, -8, -7.05], [128, 358, 53, 79, 0, -8, -7.05], [938, 263, 54, 79, 0, 0, -4.05]] }));
        tmp_mc.x = 6;
        tmp_mc.y = 278;
        this.left_btn = tmp_mc;

        tmp_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[938, 342, 54, 79, 0, 60.650000000000006, -7.05], [938, 342, 54, 79, 0, 60.650000000000006, -7.05], [74, 358, 54, 79, 0, 52.650000000000006, -4.05]] }));
        tmp_mc.x = 1125;
        tmp_mc.y = 278;
        this.right_btn = tmp_mc;

        tmp_mc = this.left_btn;
        tmp2_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[926, 163, 74, 100, 0, -1, -0.05]] }));
        new createjs.ButtonHelper(tmp_mc, 0, 1, 2, false, tmp2_mc, 0);

        tmp_mc = this.right_btn;
        tmp2_mc = new createjs.Sprite(new createjs.SpriteSheet({ images: [img], frames: [[0, 358, 74, 100, 0, 73.65, -0.05]] }));
        new createjs.ButtonHelper(tmp_mc, 0, 1, 2, false, tmp2_mc, 0);
